...
function updateControlDisplays() {
  ...
  el.click.value = String(Math.round(state.clickLevel * 100));
  el.clickInput.value = String(Math.round(state.clickLevel * 100));
  el.qsbDepth.value = String(Math.round(state.qsbDepth * 100));
  ...
  el.qrm.value = String(Math.round(state.qrmLevel * 100));
